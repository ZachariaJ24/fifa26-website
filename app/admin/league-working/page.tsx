...
import { ClientDivisionManager } from "@/components/league/client-division-manager"
import { ClientTeamManager } from "@/components/league/client-team-manager"
import { ClientStandingsViewer } from "@/components/league/client-standings-viewer"
import { Trophy, Users, BarChart3 } from "lucide-react"

export default function WorkingLeagueManagementPage() {
  return (
      ...
      <div className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <p className="hockey-subtitle mb-8">
            Direct database access - no authentication issues
          </p>
        </div>
      </div>
