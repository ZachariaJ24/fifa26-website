...
import { ConferenceManager } from "@/components/league/conference-manager"
...
export default function NewLeagueManagementPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-ice-blue-50 via-slate-50 to-rink-blue-50 dark:from-hockey-silver-900 dark:via-hockey-silver-800 dark:to-rink-blue-900/30">
      ...
      <div className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <p className="hockey-subtitle mb-8">
            Manage conferences, teams, and league standings
          </p>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pb-12">
        <Tabs defaultValue="conferences" className="space-y-8">
