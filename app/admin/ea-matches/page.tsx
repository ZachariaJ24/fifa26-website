...
import { Loader2, Search, Activity, Gamepad2, Trophy, Users, Target, Zap, Shield, Database, TrendingUp, Star, Medal, Crown } from "lucide-react"
      ...
      <div className="min-h-screen bg-gradient-to-br from-ice-blue-50 via-white to-rink-blue-50 dark:from-hockey-silver-900 dark:via-hockey-silver-800 dark:to-rink-blue-900/30">
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-hockey-silver-800 dark:text-hockey-silver-200 mb-4">Loading EA Matches</h1>
            <p className="text-hockey-silver-600 dark:text-hockey-silver-400">Connecting to EA Sports NHL servers...</p>
          </div>
        </div>
      </div>
    )
        ...
        <div className="container mx-auto text-center relative z-10">
          <div>
            ...
            <p className="hockey-subtitle mx-auto mb-12">
              Access and manage EA Sports NHL match data for all registered teams. 
              View match history, statistics, and performance analytics.
            </p>
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-hockey-silver-600 dark:text-hockey-silver-400 max-w-2xl mx-auto">
              Search for EA Sports teams or browse registered teams to view their match data and statistics.
            </p>
          </div>
              ...
              <CardContent className="p-0">
                ...
                <div className="relative h-32 bg-gradient-to-br from-ice-blue-100 via-white to-rink-blue-100 dark:from-ice-blue-900/30 dark:via-hockey-silver-800 dark:to-rink-blue-900/30 flex items-center justify-center p-6 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-r from-ice-blue-500 to-rink-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-xl">
            ...
            <div className="col-span-full text-center py-20">
              <div className="max-w-md mx-auto">
                <div className="w-20 h-20 bg-gradient-to-r from-hockey-silver-200 to-ice-blue-200 dark:from-hockey-silver-700 dark:to-ice-blue-800 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Users className="h-10 w-10 text-hockey-silver-500 dark:text-hockey-silver-400" />
                </div>
                ...
                <p className="text-hockey-silver-500 dark:text-hockey-silver-500 text-lg mb-6">
                  No teams with EA Club IDs found. Add EA Club IDs to teams in the Team Management page to view their match data.
                </p>
                <Button 
