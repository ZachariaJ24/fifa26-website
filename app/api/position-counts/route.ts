...
export async function GET() {
  try {
    ...
    const normalizePosition = (pos: string | null): string => {
      ...
      if (posLower.includes("goalkeeper") || posLower === "gk" || posLower === "g") return "Goalkeeper"
      if (posLower.includes("right back") || posLower === "rb") return "Right Back"
      if (posLower.includes("left back") || posLower === "lb") return "Left Back"
      if (posLower.includes("center back") || posLower === "cb") return "Center Back"
      if (posLower.includes("right wing") || posLower === "rw") return "Right Wing"
      if (posLower.includes("left wing") || posLower === "lw") return "Left Wing"
      if (posLower.includes("central midfielder") || posLower === "cm") return "Central Midfielder"
      if (posLower.includes("defensive midfielder") || posLower === "cdm") return "Defensive Midfielder"
      if (posLower.includes("attacking midfielder") || posLower === "cam") return "Attacking Midfielder"
      if (posLower.includes("striker") || posLower === "st") return "Striker"
      
      // Legacy hockey position support
      if (posLower.includes("center") || posLower === "c") return "Central Midfielder"
      if (posLower.includes("left defense") || posLower === "ld") return "Left Back"
      if (posLower.includes("right defense") || posLower === "rd") return "Right Back"
      if (posLower.includes("goalie") || posLower === "g") return "Goalkeeper"
