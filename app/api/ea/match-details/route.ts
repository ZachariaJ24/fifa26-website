...
async function fetchMatchFromClubMatches(
  ...
  if (homeClubId) {
    try {
      ...
      const endpoint = `https://proclubs.ea.com/api/fc/clubs/matches?matchType=${matchType}&platform=${platform}&clubIds=${homeClubId}`
  ...
  if (awayClubId && awayClubId !== homeClubId) {
    try {
      ...
      const endpoint = `https://proclubs.ea.com/api/fc/clubs/matches?matchType=${matchType}&platform=${platform}&clubIds=${awayClubId}`
