...
export async function GET() {
  try {
    ...
    const endpoints = [
      {
        name: "Club Search",
        url: "https://proclubs.ea.com/api/fc/clubs/search?platform=common-gen5&clubName=test",
      },
      {
        name: "Recent Matches",
        url: "https://proclubs.ea.com/api/fc/clubs/matches?matchType=club_private&platform=common-gen5",
      },
      {
        name: "Match Details",
        url: "https://proclubs.ea.com/api/fc/match/details?matchType=club_private&platform=common-gen5&matchId=1", // This will likely fail but we just want to check if the endpoint responds
      },
    ]
