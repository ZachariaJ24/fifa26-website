...
const ManagementPage = () => {
  ...
  // Waive player functionality removed - replaced with team transfer system

  // Claim player functionality removed - replaced with team transfer system
  ...
  // Team transfer functionality will be implemented here
