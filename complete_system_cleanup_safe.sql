-- Complete System Cleanup (Safe Version)
-- This script only cleans up what we actually want to remove
-- Run this in your Supabase SQL Editor

-- ========================================
-- PART 1: CLEANUP OLD BIDDING REFERENCES
-- ========================================
...
SELECT 'Orphaned Transfer Offers' as check_type, COUNT(*) as count
FROM player_transfer_offers pto 
LEFT JOIN players p ON pto.player_id = p.id 
WHERE p.id IS NULL;
