          ...
          <div className="hockey-premium-card overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <Table className="hockey-standings-table">
                <TableHeader>
                  <TableRow>
                    <TableHead className="text-slate-800 dark:text-slate-200 font-bold">Column Name</TableHead>
                    <TableHead className="text-slate-800 dark:text-slate-200 font-bold">Data Type</TableHead>
                    <TableHead className="text-slate-800 dark:text-slate-200 font-bold">Nullable</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {tableInfo.columns.map((column, index) => (
                    <TableRow key={index} className="hover:bg-gradient-to-r hover:from-field-green-50/50 hover:to-pitch-blue-50/50 dark:hover:from-field-green-900/20 dark:hover:to-pitch-blue-900/20 transition-all duration-200">
                      <TableCell className="font-medium text-slate-900 dark:text-slate-100">{column.column_name}</TableCell>
                      <TableCell className="text-slate-700 dark:text-slate-300">{column.data_type}</TableCell>
                      <TableCell className="text-slate-700 dark:text-slate-300">{column.is_nullable}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
