-- Cleanup Bidding System from Current Schema
-- This script removes ALL bidding-related components while preserving transfer system
-- Run this in your Supabase SQL Editor

-- ⚠️ WARNING: This will permanently delete all bidding data!

-- 1. Drop all bidding-related functions first
...
-- 5. Drop the player_bidding table completely (this is the old bidding system)
DROP TABLE IF EXISTS player_bidding CASCADE;

-- 6. Remove bidding-related system settings
...
-- 7. Clean up bidding-related notifications
...
-- 8. Remove any bidding-related data from other tables
...
-- 9. Clean up any remaining bidding-related data
...
FROM notifications 
WHERE title ILIKE '%bid%' OR message ILIKE '%bid%';
...
AND table_name LIKE '%bid%' OR table_name LIKE '%transfer%'
ORDER BY table_name;
