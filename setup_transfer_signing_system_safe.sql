-- FIFA 26 League - Transfer and Signing System Setup (Safe Version)
-- This script only creates what doesn't exist to avoid conflicts
...
-- 3. Create player_transfers table (if it doesn't exist)
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_player_transfers_updated_at') THEN
