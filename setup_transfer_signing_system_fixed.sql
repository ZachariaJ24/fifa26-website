-- FIFA 26 League - Transfer and Signing System Setup (Fixed)
...
-- 6. Set up Row Level Security (RLS) policies - SIMPLIFIED VERSION
...
-- Simple policies to avoid complex joins that might cause issues
...
-- 8. Create a function to clean up expired transfer offers
...
-- 9. Create a function to get transfer recap data
